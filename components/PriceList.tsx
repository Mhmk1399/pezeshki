...
export default function PriceList() {
  const categories = [
    { id: 1, title: "کراتین", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 1500000 },
    { id: 2, title: "کوتاهی مو", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 800000 },
    { id: 3, title: "میکاپ", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 2000000 },
    { id: 4, title: "شنیون", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 1200000 },
    { id: 5, title: "پاکسازی صورت", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 900000 },
    { id: 6, title: "اپیلاسیون", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 700000 },
    { id: 7, title: "مانیکور", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 500000 },
    { id: 8, title: "پدیکور", skill: "دارای مدرک تخصصی آرایشگری از کانادا", price: 600000 }
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8" dir="rtl">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-pink-600 mb-2">لیست قیمت خدمات</h2>
